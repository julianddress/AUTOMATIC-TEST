...
describe('CP009 - ACTUALIZAR CREDENCIALES', function() {
  ...
  it('CP009 - ACTUALIZAR CREDENCIALES', async function() {
    ...
    // 6 | type | name=old_password | javier2023
    // OLD PASSWORD
    ...
    // 8 | type | name=new_password | javier2023-2.0
    // NEW PASSWORD
    ...
    // 10 | type | name=ver_password | javieer2023-2.0
    // REPEAT - NEW PASSWORD
    ...
    // 14 | type | id=exampleInputEmail1 | javier2.0@gmail.com
    // ACTUALIZAR EMAIL
    ...
    // 16 | type | id=exampleInputPassword1 | javiM02-2.0
    // ACTUALIZAR USERNAME
