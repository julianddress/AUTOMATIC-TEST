...
describe('CP009 - ACTUALIZAR CREDENCIALES', function() {
  ...
  it('CP009 - ACTUALIZAR CREDENCIALES', async function() {
    ...
    // 6 | type | name=old_password | cr7
    // OLD PASSWORD
    await driver.findElement(By.name("old_password")).sendKeys("cr7elmejor")
    ...
    // 14 | type | id=exampleInputEmail1 | BrownJ005@gmail.com
    // ACTUALIZAR EMAIL
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("BrownJ005@gmail.com")
