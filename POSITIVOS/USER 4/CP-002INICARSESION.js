...
describe('CP002 - INICAR SESION', function() {
  ...
  it('CP002 - INICAR SESION', async function() {
    ...
    // 4 | type | name=email | thebest@gmail.com
    // EMAIL
    await driver.findElement(By.name("email")).sendKeys("thebest@gmail.com")
    // 5 | click | name=password | 
    await driver.findElement(By.name("password")).click()
    // 6 | type | name=password | cr7
    // PASSWORD
    await driver.findElement(By.name("password")).sendKeys("cr7")
    // 7 | click | name=login | 
