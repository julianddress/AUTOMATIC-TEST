...
describe('CP001 - REGISTRARSE', function() {
  ...
  it('CP001 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | Cristiano ronaldo
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("Cristiano ronaldo")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | elbichosiu
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("elbichosiu")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | thebest@gmail.com
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("thebest@gmail.com")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | cr7
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("cr7elmejor")
