...
describe('CP002 - INICAR SESION', function() {
  ...
  it('CP002 - INICAR SESION', async function() {
    ...
    // 4 | type | name=email | hernan@gmail.com
    // EMAIL
    await driver.findElement(By.name("email")).sendKeys("hernan@gmail.com")
    // 5 | click | name=password | 
    await driver.findElement(By.name("password")).click()
    // 6 | type | name=password | dariogomez12
    // PASSWORD
    await driver.findElement(By.name("password")).sendKeys("dariogomez12")
    // 7 | click | name=login | 
