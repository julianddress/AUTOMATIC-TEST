...
describe('CP009 - ACTUALIZAR CREDENCIALES', function() {
  ...
  it('CP009 - ACTUALIZAR CREDENCIALES', async function() {
    ...
    // 6 | type | name=old_password | dariogomez12
    // OLD PASSWORD
    await driver.findElement(By.name("old_password")).sendKeys("dariogomez12")
    // 7 | click | name=new_password | 
    await driver.findElement(By.name("new_password")).click()
    // 8 | type | name=new_password | dariogomez12-2.0
    // NEW PASSWORD
    await driver.findElement(By.name("new_password")).sendKeys("dariogomez12-2.0")
    // 9 | click | name=ver_password | 
    await driver.findElement(By.name("ver_password")).click()
    // 10 | type | name=ver_password | dariogomez12-2.0
    // REPEAT - NEW PASSWORD
    await driver.findElement(By.name("ver_password")).sendKeys("dariogomez12-2.0")
    ...
    // 14 | type | id=exampleInputEmail1 | hernanversion2@gmail.com
    // ACTUALIZAR EMAIL
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("hernanversion2@gmail.com")
    // 15 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 16 | type | id=exampleInputPassword1 | HernanPapuversion2
    // ACTUALIZAR USERNAME
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("HernanPapuversion2")
