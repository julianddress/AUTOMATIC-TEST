...
describe('CP011 - VISUALIZAR', function() {
  ...
  it('CP011 - VISUALIZAR', async function() {
    ...
    // 5 | type | css=.form-control | carlos
    await driver.findElement(By.css(".form-control")).sendKeys("carlos")
    ...
    // SEARCH
    await driver.findElement(By.css(".form-control")).click()
    // 8 | type | css=.form-control | carlos
    await driver.findElement(By.css(".form-control")).sendKeys("carlos")
    ...
    // 11 | type | css=.search-input | carlos
    await driver.findElement(By.css(".search-input")).sendKeys("carlos")
    ...
    // SEARCH
    await driver.findElement(By.css(".search-input")).click()
    // 14 | type | css=.search-input | carlos
    await driver.findElement(By.css(".search-input")).sendKeys("carlos")
  })
})
