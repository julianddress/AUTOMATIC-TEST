...
describe('CP006 - VISUALIZAR PROFILE', function() {
  ...
  it('CP006 - VISUALIZAR PROFILE', async function() {
    ...
    await driver.findElement(By.css(".fa-times:nth-child(1)")).click()
    // 11 | assertText | css=.user-handle | @lupesita
    // USERNAME
    assert(await driver.findElement(By.css(".user-handle")).getText() == "@lupesita")
    // 12 | assertText | css=h4 | Lupe Hurtado
    // NAME
    assert(await driver.findElement(By.css("h4")).getText() == "Lupe Hurtado")
  })
})
