...
describe('CP005 - RE-SQUAWK OR QUOTE SQUAWK', function() {
  ...
  it('CP005 - RE-SQUAWK OR QUOTE SQUAWK', async function() {
    ...
    // 8 | type | css=.popupTweet:nth-child(22) .retweet-msg | THERES MY DESTINY, PDT LUPE
    // MESSAGE
    await driver.findElement(By.css(".popupTweet:nth-child(22) .retweet-msg")).sendKeys("THERES MY DESTINY, PDT LUPE")
