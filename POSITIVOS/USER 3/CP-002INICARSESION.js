...
describe('CP002 - INICAR SESION', function() {
  ...
  it('CP002 - INICAR SESION', async function() {
    ...
    // 4 | type | name=email | lupecrack@gmail.com
    // EMAIL
    await driver.findElement(By.name("email")).sendKeys("lupecrack@gmail.com")
    // 5 | click | name=password | 
    await driver.findElement(By.name("password")).click()
    // 6 | type | name=password | hurtado12
    // PASSWORD
    await driver.findElement(By.name("password")).sendKeys("hurtado12")
    // 7 | click | name=login | 
