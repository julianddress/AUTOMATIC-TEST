...
describe('CP011 - VISUALIZAR', function() {
  ...
  it('CP011 - VISUALIZAR', async function() {
    ...
    // 5 | type | css=.form-control | maria
    await driver.findElement(By.css(".form-control")).sendKeys("maria")
    ...
    // 11 | type | css=.search-input | maria
    await driver.findElement(By.css(".search-input")).sendKeys("maria")
    ...
    // SEARCH
    await driver.findElement(By.css(".search-input")).click()
    // 14 | type | css=.search-input | maria
    await driver.findElement(By.css(".search-input")).sendKeys("maria")
  })
})
