...
describe('CP001 - REGISTRARSE', function() {
  ...
  it('CP001 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | Lupe Hurtado
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("Lupe Hurtado")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | lupesita
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("lupesita")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | lupecrack@gmail.com
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("lupecrack@gmail.com")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | hurtado12
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("hurtado12")
