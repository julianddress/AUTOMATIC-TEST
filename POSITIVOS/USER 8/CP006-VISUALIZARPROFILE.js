...
describe('CP006 - VISUALIZAR PROFILE', function() {
  ...
  it('CP006 - VISUALIZAR PROFILE', async function() {
    ...
    await driver.findElement(By.css(".fa-times:nth-child(1)")).click()
    // 11 | assertText | css=.user-handle | PablitoRey
    // USERNAME
    assert(await driver.findElement(By.css(".user-handle")).getText() == "PablitoRey")
    // 12 | assertText | css=h4 | Pablo
    // NAME
    assert(await driver.findElement(By.css("h4")).getText() == "Pablo")
  })
})
