...
describe('CP001 - REGISTRARSE', function() {
  ...
  it('CP001 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | Pablo
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("Pablo")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | PablitoRey
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("PablitoRey")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | pablitoRey@hotmail.com
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("pablitoRey@hotmail.com")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | rey12345
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("rey12345")
