...
describe('CP002 - INICAR SESION', function() {
  ...
  it('CP002 - INICAR SESION', async function() {
    ...
    // 4 | type | name=email | pablitoRey@hotmail.com
    // EMAIL
    await driver.findElement(By.name("email")).sendKeys("pablitoRey@hotmail.com")
    // 5 | click | name=password | 
    await driver.findElement(By.name("password")).click()
    // 6 | type | name=password | rey12345
    // PASSWORD
    await driver.findElement(By.name("password")).sendKeys("rey12345")
    // 7 | click | name=login | 
