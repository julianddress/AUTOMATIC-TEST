...
describe('CP009 - ACTUALIZAR CREDENCIALES', function() {
  ...
  it('CP009 - ACTUALIZAR CREDENCIALES', async function() {
    ...
    // 6 | type | name=old_password | torres12345
    // OLD PASSWORD
    await driver.findElement(By.name("old_password")).sendKeys("torres12345")
    // 7 | click | name=new_password | 
    await driver.findElement(By.name("new_password")).click()
    // 8 | type | name=new_password | torres123456
    // NEW PASSWORD
    await driver.findElement(By.name("new_password")).sendKeys("torres123456")
    // 9 | click | name=ver_password | 
    await driver.findElement(By.name("ver_password")).click()
    // 10 | type | name=ver_password | torres123456
    // REPEAT - NEW PASSWORD
    await driver.findElement(By.name("ver_password")).sendKeys("torres123456")
    ...
    // 14 | type | id=exampleInputEmail1 | juliancitoTorres@outllok.es
    // ACTUALIZAR EMAIL
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("juliancitoTorres@outllok.es")
    // 15 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 16 | type | id=exampleInputPassword1 | juliancito243
    // ACTUALIZAR USERNAME
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("juliancito243")
