...
describe('CP006 - VISUALIZAR PROFILE', function() {
  ...
  it('CP006 - VISUALIZAR PROFILE', async function() {
    ...
    await driver.findElement(By.css(".fa-times:nth-child(1)")).click()
    // 11 | assertText | css=.user-handle | juliancito24
    // USERNAME
    assert(await driver.findElement(By.css(".user-handle")).getText() == "juliancito24")
    // 12 | assertText | css=h4 | Julian
    // NAME
    assert(await driver.findElement(By.css("h4")).getText() == "Julian")
  })
})
