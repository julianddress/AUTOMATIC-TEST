...
describe('CP001 - REGISTRARSE', function() {
  ...
  it('CP001 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | sebastian
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("sebastian")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | Sebas24
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("Sebas24")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | SebastianGalindo@hotmail.com
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("SebastianGalindo@hotmail.com")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | Galindo12345
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("Galindo12345")
