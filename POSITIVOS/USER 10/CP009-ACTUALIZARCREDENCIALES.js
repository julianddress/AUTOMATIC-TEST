...
describe('CP009 - ACTUALIZAR CREDENCIALES', function() {
  ...
  it('CP009 - ACTUALIZAR CREDENCIALES', async function() {
    ...
    // 6 | type | name=old_password | Galindo12345
    // OLD PASSWORD
    await driver.findElement(By.name("old_password")).sendKeys("Galindo12345")
    // 7 | click | name=new_password | 
    await driver.findElement(By.name("new_password")).click()
    // 8 | type | name=new_password | Galindo123456
    // NEW PASSWORD
    await driver.findElement(By.name("new_password")).sendKeys("Galindo123456")
    // 9 | click | name=ver_password | 
    await driver.findElement(By.name("ver_password")).click()
    // 10 | type | name=ver_password | Galindo123456
    // REPEAT - NEW PASSWORD
    await driver.findElement(By.name("ver_password")).sendKeys("Galindo123456")
    ...
    // 14 | type | id=exampleInputEmail1 | SebastianGalindo2@hotmail.com
    // ACTUALIZAR EMAIL
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("SebastianGalindo2@hotmail.com")
    // 15 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 16 | type | id=exampleInputPassword1 | Sebas245
    // ACTUALIZAR USERNAME
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("Sebas245")
