...
describe('CP006 - VISUALIZAR PROFILE', function() {
  ...
  it('CP006 - VISUALIZAR PROFILE', async function() {
    ...
    await driver.findElement(By.css(".fa-times:nth-child(1)")).click()
    // 11 | assertText | css=.user-handle | Sebas24
    // USERNAME
    assert(await driver.findElement(By.css(".user-handle")).getText() == "Sebas24")
    // 12 | assertText | css=h4 | sebastian
    // NAME
    assert(await driver.findElement(By.css("h4")).getText() == "sebastian")
  })
})
