...
describe('CP002 - INICAR SESION', function() {
  ...
  it('CP002 - INICAR SESION', async function() {
    ...
    // 4 | type | name=email | SebastianGalindo@hotmail.com
    // EMAIL
    await driver.findElement(By.name("email")).sendKeys("SebastianGalindo@hotmail.com")
    // 5 | click | name=password | 
    await driver.findElement(By.name("password")).click()
    // 6 | type | name=password | Galindo12345
    // PASSWORD
    await driver.findElement(By.name("password")).sendKeys("Galindo12345")
    // 7 | click | name=login | 
