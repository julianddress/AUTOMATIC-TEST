...
describe('CP001.1 - REGISTRARSE', function() {
  ...
  it('CP001.1 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | sebas manu
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("sebas manu")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | sebasmanu
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("sebasmanu")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | sebitas12@gmail.com
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("sebitas12@gmail.com")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | manusebas00
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("manusebas00")
