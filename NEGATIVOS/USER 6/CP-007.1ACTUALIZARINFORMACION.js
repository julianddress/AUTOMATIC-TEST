...
describe('CP007.1 - ACTUALIZAR INFORMACION', function() {
  ...
  it('CP007.1 - ACTUALIZAR INFORMACION', async function() {
    ...
    // 6 | type | id=exampleInputEmail1 | SEBAS SEBAS SEBAS SEBAS SEBAS SEBAS
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("SEBAS SEBAS SEBAS SEBAS SEBAS SEBAS")
    // 7 | click | name=bio | 
