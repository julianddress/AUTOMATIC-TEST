...
describe('CP001.1 - REGISTRARSE', function() {
  ...
  it('CP001.1 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | Camila rojas
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("Camila rojas")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | camilaroj
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("camilaroj")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | camirojitas@gmail.com\n
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("camirojitas@gmail.com\\n")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | cami12rojas\n
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("cami12rojas\\n")
