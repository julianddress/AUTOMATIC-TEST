...
describe('CP001.1 - REGISTRARSE', function() {
  ...
  it('CP001.1 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | karla clara
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("karla clara")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | karlita
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("karlita")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | karlamonti@gmail.com
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("karlamonti@gmail.com")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | karla12rot
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("karla12rot")
