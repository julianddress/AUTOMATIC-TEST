...
describe('CP007.1 - ACTUALIZAR INFORMACION', function() {
  ...
  it('CP007.1 - ACTUALIZAR INFORMACION', async function() {
    ...
    // 6 | type | id=exampleInputEmail1 | RADAMEL RADAMEL RADAMEL RADAMEL
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("RADAMEL RADAMEL RADAMEL RADAMEL")
    // 7 | click | name=bio | 
