...
describe('CP001.1 - REGISTRARSE', function() {
  ...
  it('CP001.1 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | Monica castro
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("Monica castro")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | monicacas
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("monicacas")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | monicacas@gmail.com
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("monicacas@gmail.com")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | monica1212
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("monica1212")
