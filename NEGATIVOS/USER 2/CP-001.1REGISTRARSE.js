...
describe('CP001.1 - REGISTRARSE', function() {
  ...
  it('CP001.1 - REGISTRARSE', async function() {
    ...
    // 5 | type | id=exampleInputEmail1 | Mauricio jada
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("Mauricio jada")
    // 6 | click | name=username | 
    await driver.findElement(By.name("username")).click()
    // 7 | type | name=username | maurijada
    // USERNAME
    await driver.findElement(By.name("username")).sendKeys("maurijada")
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | maurijada@gmail.com
    // EMAIL
    await driver.findElement(By.css(".form-group:nth-child(4) > #exampleInputEmail1")).sendKeys("maurijada@gmail.com")
    // 10 | click | id=exampleInputPassword1 | 
    await driver.findElement(By.id("exampleInputPassword1")).click()
    // 11 | type | id=exampleInputPassword1 | mauri1212
    // PASSWORD
    await driver.findElement(By.id("exampleInputPassword1")).sendKeys("mauri1212")
