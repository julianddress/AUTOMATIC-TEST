...
describe('CP007.1 - ACTUALIZAR INFORMACION', function() {
  ...
  it('CP007.1 - ACTUALIZAR INFORMACION', async function() {
    ...
    // 6 | type | id=exampleInputEmail1 | JORGE JORGE JORGE JORGE JORGE JORGE
    // NAME
    await driver.findElement(By.id("exampleInputEmail1")).sendKeys("JORGE JORGE JORGE JORGE JORGE JORGE")
    // 7 | click | name=bio | 
